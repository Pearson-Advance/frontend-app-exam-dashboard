export const termsText = () => (
  <>
    ...
    <p> By accessing this website and checking the box below you understand and agree to the terms set forth
      ...
      This Agreement represents your understanding and acceptance of Pearson VUE&apos;s Privacy and Cookies
      Policy- Opens in new tab, including the collection of your data and the monitoring of your entire
      testing session through the use CCTV and Pearson VUE&apos;s Terms of Service Policy- Opens in new tab,
    ...
    <p>You agree that for purposes of registering and scheduling your exam on Pearson VUE&apos;s website or during
      ...
      forth in our Privacy and Cookies Policy- Opens in new tab
    </p>
    ...
    <p>You understand and agree that Pearson VUE, as a data processor for your Test Sponsor, the data controller,
      ...
      as a data subject, please go to Pearson VUE&apos;s Privacy and Cookies Policy- Opens in new tab
    </p>
    ...
    <p> Where selected by your Test Sponsor, you agree that Pearson VUE will collect your palm vein
      ...
      Testing policies includes agreement to the Privacy and Cookies Policy.
    </p>
